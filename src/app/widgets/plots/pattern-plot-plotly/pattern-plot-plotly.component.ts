...
@Component({
  selector: 'app-pattern-plot-plotly',
  templateUrl: './pattern-plot-plotly.component.html',
  styleUrls: ['./pattern-plot-plotly.component.scss']
})
export class PatternPlotPlotlyComponent implements OnInit {
